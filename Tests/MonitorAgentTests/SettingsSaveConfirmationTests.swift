...
final class SettingsSaveConfirmationTests: XCTestCase {
    ...
    func testSubscriptionQuotaSettingsArePresentedAsOneGroup() {
        ...
        XCTAssertEqual(QuotaSettingsCopy.cursorTitle, "Cursor")
        XCTAssertEqual(QuotaSettingsCopy.cursorDescription, "Show Cursor subscription quota in the main panel.")
        XCTAssertEqual(QuotaSettingsCopy.cursorToggleAccessibilityLabel, "Cursor Subscription Quota")
